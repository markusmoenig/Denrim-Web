        ...
        <section className={styles.latest} aria-labelledby="latest-heading">
          ...
          <article className={styles.releaseCard}>
            ...
            <h2 id="latest-heading">
              <Link to="/blog/denrim-forge-v1-5">
                Denrim: Forge 1.5 — Object Animation, Hierarchies, and Project Merging
              </Link>
            </h2>
            <p>
              A complete transform-animation timeline, parent-child motion,
              synchronized multi-item playback, project merging, and custom HDR
              environments for macOS and iPadOS.
            </p>
            <Link className={styles.readMore} to="/blog/denrim-forge-v1-5">
